...
<jsp:include page="./../header.jsp"></jsp:include>
	<div class="container">
		...
		<c:forEach var="boardDetailInfo" items='${boardDetailInfo}'>
			...
			<button type="button" class="btn btn-primary" onclick="location.href='/hboard/showReplyForm?boardNo=${boardDetailInfo.boardNo}&ref=${boardDetailInfo.ref}&step=${boardDetailInfo.step}&refOrder=${boardDetailInfo.refOrder}';">답글달기</button>
			<button type="button" class="btn btn-primary" onclick="location.href='/hboard/modifyBoard?boardNo=${boardDetailInfo.boardNo}'">수정</button>
