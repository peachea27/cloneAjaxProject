	...
	<div class="container">
		...
		<form action="modifyBoardSave" method="post">
			<div class="input-group mb-3">
  			...
  			<input type="hidden" class="form-control"  id="boardNo" name="boardNo" readonly value='${boardDetailInfo.boardNo}'/>
			<div class="input-group mb-3">
			...
			<!-- 	내용		 -->
			<div>
	  		<textarea id="summernote" name="content">${boardDetailInfo.content}</textarea>
			</div>
			
			<button type="submit" class="btn btn-primary" onclick="return validBoard();">저장</button>
			<button type="reset" class="btn btn-warning" onclick="location.href='/cboard/viewBoard?boardNo=${board.boardNo}'" >취소</button>
		</form>
	</div>
