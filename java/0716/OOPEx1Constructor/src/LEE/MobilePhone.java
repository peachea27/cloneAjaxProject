...
public class MobilePhone {
	...
	private int mainMemory;
	 ...
	 public MobilePhone() {// 7^^ 기본 생성자 >> 객체가 만들어질 때 딱 어떤 일을 해주어야 한다
...
//	 
	 ...
	 public MobilePhone(String barndName, String modelName, int mainMemory, String color) {
...
//		 this(); Constructor call must be the first statement in a constructor//
	 ...
	 //11^^
	 public MobilePhone(String brandName, String modelName) {//또다른 생성자 오버로딩
//		 this.brandName = brandName;
//		 this.modelName= modelName;
//		 this.mainMemory=256;
//		 this.color="흰색";	 
...
//	 }
	 ...
	 //9-1^^메서드
//	   18^^//getter, setter
	 //getter나 setter에 static 메서드로 만들 수 있을까?
	 String getBrandName(){
		 return this.brandName;//this를 생략해도 잘 가져온다
	 }
...
//		 this.mainMemory=mainMemory;
//	 }
	 //만약 메모리를 1TB까지만 업그레이드 가능하다고 하면
	 boolean setMainMemory (int mainMemory) {
		 boolean result = false;
		 if (mainMemory <= 1024) {//GB
			 this.mainMemory=mainMemory;
			 result = true;
		 }
		 return result;
